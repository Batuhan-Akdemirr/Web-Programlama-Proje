...
namespace ePizzaHub.WebUI.Controllers
{
    ...
    {
        //key_id: rzp_test_Xm7ER9hA5h4Q6j
        //key_secret:liK1rPCmx2ea57X4JeUxdiG6
        ...
        public IActionResult Index()
        {
            ...
            payment.OrderId = _paymentService.CreateOrder(payment.GrandTotal * 1, payment.Currency, payment.Receipt);
